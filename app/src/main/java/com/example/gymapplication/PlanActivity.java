...
public class PlanActivity extends AppCompatActivity {
    ...
    private void initRecViews() {
        ...
        mondayAdapter.setPlans(getPlansById("Monday"));
        ...
        tuesdayAdapter.setPlans(getPlansById("Tuesday"));
        ...
        wednesdayAdapter.setPlans(getPlansById("Wednesday"));
        ...
        thursdayAdapter.setPlans(getPlansById("Thursday"));
        ...
        fridayAdapter.setPlans(getPlansById("Friday"));
        ...
        saturdayAdapter.setPlans(getPlansById("Saturday"));
        ...
        sundayAdapter.setPlans(getPlansById("Sunday"));
    }
